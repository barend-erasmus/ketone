...
export class APIUsersRouter {
    ...
    /**
     * @api {get} /api/users/:clientId Get Users
     * @apiName GetUsers
     * @apiGroup Users
     *
    ...
    public static async getUsers(req: express.Request, res: express.Response) {
        ...
        try {
            ...
            const users: User[] = await APIUsersRouter.getUserService().list(user.username, req.params.clientId);
    ...
    /**
     * @api {get} /api/users/:clientId/:username Get User
     * @apiName GetUser
     * @apiGroup Users
     *
     * @apiParam {string} clientId Client Id
    ...
    public static async getUser(req: express.Request, res: express.Response) {
        ...
        try {
            ...
            const result: User = await APIUsersRouter.getUserService().find(user.username, req.params.username, req.params.clientId);
